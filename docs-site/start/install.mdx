...
| Debian, Ubuntu 24.04+, Mint 22+, Pop!\_OS, Tuxedo OS | `sudo apt install ./ShalomFlow_*_amd64.deb` |
| Everything else, including Fedora and openSUSE | `chmod +x ShalomFlow_*.AppImage`, then run it |
